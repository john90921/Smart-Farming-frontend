                          ...
                          child: Column(
                            children: [
                              ...
                              Selector<PlantProvider, List>(
                                selector: (_, plantProvider) => plantProvider.recentPlants,
                                builder: (context, recentPlants, child) {
                                  if (recentPlants.isEmpty) {
                                    return Text("No recent detection records.");
                                  }
                                  return Column(
                                    children: recentPlants.map((plant) => DetectionRecord(
                                      Id: plant.id,
                                      disease: dragonFruitDiseases[plant.diseaseId]['name'],
                                      dateTime: plant.created_at,
                                      image: plant.image,
                                      icon: Icons.delete,
