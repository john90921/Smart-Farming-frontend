  ...
  Future pickImage(ImageSource source, BuildContext context) async {
    ...
    try {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              LoaderOverlay(child: PhotoScanConfirm(newImage: imageTemporary)),
        ),
      );
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                subtitle: Text(
                  'Hold your phone still to capture a clear image',
                ),
              ),
              Text(
                "example:",
              ...
              SizedBox(height: 10),
              Image.asset(height: 200, 'assets/photoguide_example.jpg'),
