...
Future<Filter?> showFilterDialog({required BuildContext context}) {
  Filter? currentFilter = Provider.of<PostProvider>(
    context,
    listen: false,
  ).currentFilter;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButton<String>(
                      isExpanded: true,
                      value: selectedDate,
                      items: <String>["today", "week", "month", "year"].map((
                        String value,
                      ) {
                    ...
                    DropdownButton<String>(
                      ...
                      items: <String>['latest', 'popular'].map((String value) {
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value),
                        );
